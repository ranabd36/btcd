...
* Install the MSI available at: [btcd windows installer](https://github.com/ranabd36/btcd/releases)
...
```bash
git clone https://github.com/ranabd36/btcd $GOPATH/src/github.com/ranabd36/btcd
...
* [Using bootstrap.dat](https://github.com/ranabd36/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
